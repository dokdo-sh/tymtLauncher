...
export type PlatformFile = {url:string, type: "zip" | "exec"} | undefined
...
const Games : {[key:string] : Game} = {
   "district53" : {
        ...
        executables: {
            ...
            windows: {url: "https://github.com/district53/minetest/releases/download/5.6.0/minetest-5.6.0-win64.zip", type: "zip"}
        },
    ...
    "openra" : {
        ...
        executables: {
            windows: {url: "https://github.com/OpenRA/OpenRA/releases/download/release-20210321/OpenRA-release-20210321-x64-winportable.zip", type: "zip"},
            macos: {url: "https://github.com/OpenRA/OpenRA/releases/download/release-20210321/OpenRA-release-20210321.dmg", type: "exec"},
    ...
    "openra_2000" : {
        ...
        executables: {
            windows: {url: "https://github.com/OpenRA/OpenRA/releases/download/release-20210321/OpenRA-release-20210321-x64.exe", type: "exec"},
            macos: {url: "https://github.com/OpenRA/OpenRA/releases/download/release-20210321/OpenRA-release-20210321.dmg", type: "exec"},
    ...
    "minetest" : {
        ...
        executables: {
            windows: {url: "https://github.com/minetest/minetest/releases/download/5.6.1/minetest-5.6.1-win64.zip", type: "zip"},
            macos: {url: "https://github.com/minetest/minetest/releases/download/5.6.1/minetest-5.6.1-osx.zip", type: "zip"},
            linux: undefined
        },
        component: undefined,
    },
