...
import { BsArrowDownLeft, BsArrowRight, BsArrowUpRight, BsClock, BsReceipt, BsCheckCircle } from "react-icons/bs";
                    ...
                    <div className="flex-1 grow">
                        <div className=" h-full divide-y divide-gray-800/30">
                            ...
                            <div className="py-4 items-center hover:bg-gray-800/30 cursor-pointer select-none px-6" 
                                onClick={
                                    () => {
                                        props.setModalTx(transaction.signature);    //https://explorer.solana.com/address/2AQdpHJ2JpcEgPiATUXjQxA8QmafFegfQwSLWSprPicm?cluster=devnet
                                        props.setShowTransaction(true)
                                    }
                                }
                            >
