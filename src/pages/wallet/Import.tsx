...
const Passphrase = (props: { setPassphrase: (passphrase: string) => void }) => {
    ...
    return (
        <div>
            <div className="py-4"> 
                <a href="#" className="px-4  hover:underline flex" onClick={() => window.location.href = "/session"}> <MdArrowBack className="text-2xl" /> Go back to login</a>
            </div>
...
const WalletSetup = (props: { passphrase: string, password: string }) => {
    ...
    return (
        <div className="px-4 py-8">
            <div className="pb-10">
                <div className="">
                    <a href="#" className="px-4  hover:underline flex" onClick={() => window.location.href = "/session"}> 
