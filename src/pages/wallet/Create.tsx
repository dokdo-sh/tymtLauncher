        ...
        <div className="px-6">
            <div className="">
                ...
                <div className="text-gray-400 text-center  pt-8">
                    <p>Remember, saving your mnemonic in a safe place is the only get to recover your wallet!</p> 
                    <br />
                ...
                <div className="flex flex-row mb-2 w-full"> 
                    ...
                    <Button className="w-fit bg-red-500/50 hover:bg-red-500 px-2" onClick={() => {refreshMnemonic()}}>
                        <BiRefresh/> 
                ...
                <div className="rounded-t bg-dark-tertiary mx-auto  py-4 text-sm text-center select-none hover:bg-dark-hoverish font-mono  font-bold text-base  ">
                    <div className="flex flex-row w-fit mx-auto gap-3 px-3 flex-wrap items-center justify-items-center"> 
                        { mnemonic.split(" ").map((word) => ( 
                            <div className="border border-gray-800 text-gray-400 px-1 py-1 rounded">{word}</div> 
                        ))}
                    </div>
                </div>
            </div>
        ...
        <div className="px-6">
            <div className="">
                ...
                <div className="flex flex-row mt-3"> 
                    <div className="grow"></div> 
                    <Button className="w-fit bg-red-500/50 hover:bg-red-500 px-2 border border-dark-secondary flex items-center ease-in duration-300 text-sm" onClick={() => { copyPP();}}><BiCopy className="mr-2"/> 
        ...
        <div className="px-6">
            ...
            <div className="py-5 flex w-fit mx-auto">
                <div className="px-3"> 
                    ...
                    <input type="text" name="" className={`text-center p-3  bg-dark-secondary rounded-lg outline-greenish w-40 ${input1 != correct1? 'bg-dark-secondary' : 'bg-green-800'}`} value={input1} onChange={(e: React.ChangeEvent<HTMLInputElement>) => {if (input1 != correct1) {setInput1(e.currentTarget.value); if (correct1 == e.currentTarget.value) {i2.current.focus()}}}} onFocus={() => {refreshShuffle(); setCurrentInput("1")}} readOnly={input1 == correct1} ref={i1}/>
                </div>
                <div className="px-3"> 
                    <div className="text-center py-4 font-black text-sm">Sixth word</div> 
                    <input type="text" name="" ref={i2} className={`text-center p-3  bg-dark-secondary rounded-lg outline-greenish w-40 ${input2 != correct2? 'bg-dark-secondary' : 'bg-green-800'}`} value={input2}  onChange={(e: React.ChangeEvent<HTMLInputElement>) => {if (input2 != correct2) {setInput2(e.currentTarget.value); if (correct2 == e.currentTarget.value) {i3.current.focus()} } }} onFocus={() => {refreshShuffle(); setCurrentInput("2")}} readOnly={input2 == correct2} />
                </div>
                <div className="px-3"> 
                    <div className="text-center py-4 font-black text-sm">Ninth word</div> 
                    <input type="text" ref={i3}  value={input3} onChange={(e: React.ChangeEvent<HTMLInputElement>) => {if (input3 != correct3) {setInput3(e.currentTarget.value); if (correct1 == e.currentTarget.value) {i1.current.focus()}}}} name="" className={`text-center p-3  w-40 bg-dark-secondary rounded-lg outline-greenish ${input3 != correct3? 'bg-dark-secondary' : 'bg-green-800'}`} readOnly={input3 == correct3} onFocus={() => {refreshShuffle(); setCurrentInput("3")}}/>
                </div>
            </div>
