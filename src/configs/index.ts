...
export const eth_rpc_url = process.env.REACT_APP_NETWORK_NAME === "mainnet" ? "https://eth-mainnet.g.alchemy.com/v2/" + alchemy_api_key : "https://eth-goerli.g.alchemy.com/v2/" + alchemy_api_key
...
export const matic_rpc_url = process.env.REACT_APP_NETWORK_NAME === "mainnet" ? "https://polygon-mainnet.g.alchemy.com/v2/" + alchemy_api_key : "https://polygon-mumbai.g.alchemy.com/v2/" + alchemy_api_key
...
export const op_rpc_url = process.env.REACT_APP_NETWORK_NAME === "mainnet" ? "https://opt-mainnet.g.alchemy.com/v2/" + alchemy_api_key : "https://opt-goerli.g.alchemy.com/v2/" + alchemy_api_key

export const avax_api_url = process.env.REACT_APP_NETWORK_NAME === "mainnet" ? process.env.REACT_APP_MAINNET_AVAX_URL : process.env.REACT_APP_TESTNET_AVAX_URL
export const avax_rpc_url = process.env.REACT_APP_NETWORK_NAME === "mainnet" ? process.env.REACT_APP_MAINNET_AVAX_PROVIDER : process.env.REACT_APP_TESTNET_AVAX_PROVIDER

export const sol_rpc_url = process.env.REACT_APP_NETWORK_NAME === "mainnet" ? "https://solana-mainnet.g.alchemy.com/v2/" + alchemy_api_key : "" + alchemy_api_key